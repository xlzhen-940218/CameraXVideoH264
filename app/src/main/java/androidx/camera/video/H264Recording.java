...
public final class H264Recording implements AutoCloseable {

    // Indicates the recording has been explicitly stopped by users.
    private final AtomicBoolean mIsClosed = new AtomicBoolean(false);
    private final H264Recorder mRecorder;
    ...
    @SuppressLint("RestrictedApi")
    H264Recording(@NonNull H264Recorder recorder, long recordingId, @NonNull OutputOptions options,
    ...
    /**
     * Creates an {@link H264Recording} from a {@link PendingRecording} and recording ID.
     *
    ...
    @SuppressLint("RestrictedApi")
    @NonNull
    static H264Recording from(@NonNull H264PendingRecording pendingRecording, long recordingId) {
        Preconditions.checkNotNull(pendingRecording, "The given PendingRecording cannot be null.");
        return new H264Recording(pendingRecording.getRecorder(),
                recordingId,
    ...
    /**
     * Creates an {@link H264Recording} from a {@link PendingRecording} and recording ID in a
     * finalized state.
     *
    ...
    @SuppressLint("RestrictedApi")
    @NonNull
    static H264Recording createFinalizedFrom(@NonNull H264PendingRecording pendingRecording,
                                             long recordingId) {
        Preconditions.checkNotNull(pendingRecording, "The given PendingRecording cannot be null.");
        return new H264Recording(pendingRecording.getRecorder(),
                recordingId,
     ...
     * {@link H264Recording#stop()} and will ignore the lifecycle events or source state changes.
