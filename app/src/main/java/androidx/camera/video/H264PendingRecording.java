 ...
 * to occur through the controls of the {@link H264Recording} class returned by
...
public final class H264PendingRecording {

    private final Context mContext;
    private final H264Recorder mRecorder;
    private final OutputOptions mOutputOptions;
    private Consumer<VideoRecordEvent> mEventListener;
    private Consumer<EncodedData> mVideoListener;
    private Consumer<EncodedData> mAudioListener;
    private Executor mListenerExecutor;
    private boolean mAudioEnabled = false;
    private boolean mIsPersistent = false;

    @SuppressLint("RestrictedApi")
    H264PendingRecording(@NonNull Context context, @NonNull H264Recorder recorder,
    ...
    @Nullable
    Consumer<EncodedData> getVideoListener() {
        return mVideoListener;
    }
    @Nullable
    Consumer<EncodedData> getAudioListener() {
     ...
     * in the recording. If this method is not called, the {@link H264Recording} generated by
    ...
    @NonNull
    public H264PendingRecording withAudioEnabled() {
     ...
     * {@link H264Recording#stop()} or {@link H264Recording#close()} and will ignore events that would
    ...
    @NonNull
    public H264PendingRecording asPersistentRecording() {
        mIsPersistent = true;
        return this;
    }
     ...
     *
     * <p>If there are no errors starting the recording, the returned {@link H264Recording}
     * can be used to {@link H264Recording#pause() pause}, {@link H264Recording#resume() resume},
     * or {@link H264Recording#stop() stop} the recording.
     *
     ...
     * {@link H264Recording} will be in a finalized state, and all controls will be no-ops.
     *
     * <p>If the returned {@link H264Recording} is garbage collected, the recording will be
    ...
    @NonNull
    @CheckResult
    public H264Recording start(
            @NonNull Executor listenerExecutor,
            @NonNull Consumer<VideoRecordEvent> listener,
            @NonNull Consumer<EncodedData> videoListener,
            @NonNull Consumer<EncodedData> audioListener) {
